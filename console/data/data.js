...
const COURSES = [
  {
    ...
    date: "2026-08-20（四）",
    time: "08:40 報到／09:00 開場／09:10–12:00 上午第 1–3 節／13:30 下午報到／13:40–16:15 下午第 5–7 節／16:15–16:30 回饋",
    location: "國立臺灣史前文化博物館 2058 會議室",
    tags: ["AI工作坊", "職場實作", "通用版教案"],
    version: "V1",
    updatedAt: "2026-08-10",
    summary: "以虛構的遠景科技「2026 員工家庭日」情境，練習把交辦、信件、會議與成果整理成可交付的工作流程；正式課程為上午第 1–3 節、下午第 5–7 節，16:15 開始回饋並於 16:30 結束。",
    resources: [
